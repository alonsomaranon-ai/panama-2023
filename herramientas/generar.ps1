...
$cuerpo2 = @"
    <figure class="linea-tiempo">
      <div class="rotulo">Los nueve momentos, y a qué día saltar</div>
      <svg viewBox="0 0 1000 74" role="img" aria-label="Línea de tiempo del 19 de octubre al 2 de diciembre de 2023 con nueve momentos marcados">
        <line x1="40" y1="40" x2="960" y2="40" stroke="#C9C4BC" stroke-width="1"/>
        <g stroke="#A65A2E" stroke-width="2">
          <line x1="40"  y1="24" x2="40"  y2="56"/>
          <line x1="61"  y1="24" x2="61"  y2="56"/>
          <line x1="124" y1="28" x2="124" y2="52"/>
          <line x1="186" y1="28" x2="186" y2="52"/>
          <line x1="228" y1="28" x2="228" y2="52"/>
          <line x1="312" y1="28" x2="312" y2="52"/>
          <line x1="437" y1="28" x2="437" y2="52"/>
          <line x1="876" y1="24" x2="876" y2="56"/>
          <line x1="960" y1="24" x2="960" y2="56"/>
        </g>
        <g fill="#6E6862" font-family="'Space Mono', monospace" font-size="13">
          <text x="40" y="14">19 OCT</text>
          <text x="312" y="14" text-anchor="middle">1 NOV</text>
          <text x="960" y="14" text-anchor="end">2 DIC</text>
        </g>
      </svg>
      <ol class="hitos">
        <li><a href="#d-19-oct"><b>19 oct</b> El fotógrafo Aubrey Baxter pierde un ojo frente a la Asamblea.</a></li>
        <li><a href="#d-20-oct"><b>20 oct</b> Se aprueba y promulga la Ley 406 en una sola jornada.</a></li>
        <li><a href="#d-23-oct"><b>23 oct</b> Empiezan los bloqueos simultáneos en todo el país.</a></li>
        <li><a href="#d-26-oct"><b>26 oct</b> Muere Agustín Morales, atropellado en un corte de ruta.</a></li>
        <li><a href="#d-28-oct"><b>28 oct</b> Veinte mil personas marchan por la Cinta Costera.</a></li>
        <li><a href="#d-1-nov"><b>1 nov</b> Muere el docente Tomás Milton Cedeño García.</a></li>
        <li><a href="#d-7-nov"><b>7 nov</b> Un civil dispara y mata a dos manifestantes en Chame.</a></li>
        <li><a href="#d-28-nov"><b>28 nov</b> La Corte Suprema declara inconstitucional el contrato.</a></li>
        <li><a href="#d-2-dic"><b>2 dic</b> Se abren las últimas vías bloqueadas.</a></li>
      </ol>
      <figcaption>Entre el 7 y el 28 de noviembre pasan tres semanas sin un hito: el país siguió cortado, esperando a la Corte.</figcaption>
    </figure>
